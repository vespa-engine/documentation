---
title: "vespa curl"
description: "Access Vespa directly using curl"
---
...
Execute curl with the appropriate URL, certificate and private key for your application. Assumes MTLS authentication.
