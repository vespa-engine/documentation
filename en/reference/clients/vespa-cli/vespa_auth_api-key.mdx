...
description: "Create a new developer key for headless authentication with Vespa Cloud control plane"
---
...
See [/en/security/guide.html](/en/security/guide) for more details about developer keys.
