...
<table className="vespa-table">
  ...
  <tbody>
    <tr>
      <td>&#42;&#42;Voluntary Disruption&#42;&#42;</td>
      <td>Scaling down, rolling upgrades, or node maintenance.</td>
      <td>The preStop hook detects a voluntary disruption, stops the Vespa Container cluster from accepting new traffic, flushes in-memory data to disk for Content clusters, and ensures a clean exit before the Pod is deleted.</td>
    </tr>
    <tr>
      <td>&#42;&#42;Involuntary Disruption&#42;&#42;</td>
      <td>Node hardware failure, kernel panic, or eviction.</td>
      <td>Kubernetes initiates the termination. The preStop hook attempts to run to flush data and close connections. However, if the Pod is lost abruptly. the hook cannot run, and recovery relies on Vespa's data replication.</td>
    </tr>
  </tbody>
</table>
