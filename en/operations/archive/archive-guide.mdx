...
<CardGroup>
  <Card title="AWS S3" icon="cloud" href="/en/operations/archive/archive-guide-aws" horizontal />
  <Card title="Google Cloud Storage" icon="cloud" href="/en/operations/archive/archive-guide-gcp" horizontal />
</CardGroup>
