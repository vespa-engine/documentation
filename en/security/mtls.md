...
See accompanying [reference](../reference/security/mtls) for details on configuration syntax.
...
and check [vespa-logfmt](../reference/operations/self-managed/tools.html#vespa-logfmt) for any TLS-related error messages
...
[Disable hostname validation](../reference/security/mtls#top-level-elements) if this is not the case.
