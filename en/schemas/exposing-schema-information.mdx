...
description: "Some applications need to expose information about schemas to data plane clients. This document explains how to add an API for that to your application."
---

You need to know two things:

- Your application can expose any custom API by implementing a [handler](/en/applications/request-handlers).
...
<Steps>
<Step title="Make sure your application package can contain Java components">
...
<Step title="Add a handler exposing schema info">
...
<Step title="Add the new API handler to your container cluster">
...
<Step title="Deploy the modified application">
```sh
$ mvn install
$ vespa deploy
```
...
<Step title="Verify that it works">
```sh
