...
Vespa provides a <a href="../operations-selfhosted/tools-self-managing.html#vespa-significance">CLI tool</a> for generating significance model files from Vespa documents.
