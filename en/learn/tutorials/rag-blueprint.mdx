...
<Frame>
![RAG Blueprint Overview](/assets/img/tutorials/rag-blueprint-overview.svg)
</Frame>
...
<AccordionGroup>
<Accordion title="Why don't you use ColBERT for ranking?">
...
<Accordion title="Which embedding models can I use with Vespa?">
...
<Accordion title="Do I need to use an LLM with Vespa?">
...
<Accordion title="Why do we use binary vectors for the document embeddings?">
...
<Accordion title="How can you say that Vespa can scale to any data and query load?">
