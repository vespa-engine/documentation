...
The [services.xml](../../reference/applications/services/services.html) file defines the services that
...
[type](../../reference/schemas/schemas.html#field), such as `string`, `int`, or
...
Here, we also use the [index](../../reference/schemas/schemas.html#index) property,
...
format](../../reference/schemas/document-json-format.html) before it can be fed to Vespa:
