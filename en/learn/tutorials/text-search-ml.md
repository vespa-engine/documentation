...
set the query parameter [`ranking.listFeatures`](../../reference/api/query.html#ranking.listfeatures)  to `true`.
For example, below is the body of a post request that in a [query](../../querying/query-language.html),
