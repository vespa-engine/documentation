...
Support options and other resources like status tracking
are found at [Vespa Support](https://vespa.ai/support/).
...
To escalate a support case for response within defined SLA, first create the case,
then use "Escalate to oncall" to page the Vespa Team:

<img src="/assets/img/support-ticket.png" alt="Example support case" width="400" />

An escalation will be acknowledged in the support case ticket within support SLA.
...
* The teams can mutually agree to use a shared Slack-channel for status and coordinated work -
  in this case, the support case will have a link to the Slack channel
...
A customer can request a joint post-mortem meeting after the Vespa.ai-internal post-mortem is completed.
