...
There are guides to help estimate resource use, see [attributes](../content/attributes.html),
...
Use the [field change procedure](../operations/procedure-change-attribute-index.html)
...
read more about the [content node data structures](../content/proton.html) - in short:
...
* `Documentmetastore` is the document ID mapping -
  see [attributes](../content/attributes.html#document-meta-store)
