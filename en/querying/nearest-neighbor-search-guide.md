...
redirect_from:
  - /en/nearest-neighbor-search-guide
---
 ...
 See also the generic [Vespa performance - a practical guide](../performance/practical-search-performance-guide).
...
[the Vespa JSON feed format](../reference/schemas/document-json-format.html). 
...
[Vespa JSON document operation](../reference/schemas/document-json-format.html) format.
...
using dense representations. The first query example uses [exact nearest neighbor search](nearest-neighbor-search)
...
see [multithreaded searching and ranking](../performance/practical-search-performance-guide#multithreaded-search-and-ranking)
...
[Approximate Nearest Neighbor Search using HNSW Index](approximate-nn-hnsw)
...
The value of the `distance` depends on the [distance-metric](../reference/schemas/schemas.html#distance-metric) used. 
...
See [match-features reference](../reference/schemas/schemas.html#match-features).
...
[re-ranking/filtering searcher](../ranking/reranking-in-searcher). 
...
The result hits also include [match-features](../reference/schemas/schemas.html#match-features) which 
