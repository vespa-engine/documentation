...
<table className="vespa-table">
  ...
  <tbody>
    <tr>
      ...
      <td>With multiple groups it becomes safe to take out a full group for upgrade instead of just one node at a time.  <a href="/en/operations/self-managed/live-upgrade" aria-label="Read more">Read more</a>.</td>
    </tr>
    <tr>
      <td>&#42;&#42;Query throughput&#42;&#42;</td>
      <td>Applications with high query rates and/or high static query cost can use groups to scale to higher query rates since Vespa will automatically send a query to just a single group. <a href="/en/performance/sizing-search" aria-label="Read more">Read more</a></td>
    </tr>
    <tr>
      <td>&#42;&#42;Topology&#42;&#42;</td>
      <td>By using groups you can control replica placement over network switches or racks to ensure there is redundancy at the switch and rack level.</td>
    </tr>
  </tbody>
</table>
