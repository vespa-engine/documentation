...
1. Using the [Vespa Cloud secret store](../cloud/security/secret-store) to store the API key. 
...
[running LLMs in your application](local-llms.html) for more information.
