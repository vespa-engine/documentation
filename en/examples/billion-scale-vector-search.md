...
This sample app uses the Microsoft SPACEV vector dataset from https://big-ann-benchmarks.com/.
...
$ python3 app/src/main/python/recall.py   --endpoint $(vespa status --format=plain)search/ \
