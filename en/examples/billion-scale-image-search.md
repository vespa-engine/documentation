...
All this combined using [Vespa's query language](../querying/query-language.html),
...
in [Vespa stateless](../learn/overview.html) containers.
The exported CLIP model encodes a free-text prompt to a joint image-text embedding space with 768 dimensions.
- [HNSW](../querying/approximate-nn-hnsw.html) indexing of vector centroids drawn
...
memory mapped [paged attribute tensors](../content/attributes.html#paged-attributes).
...
* [Homebrew](https://brew.sh/) to install [Vespa CLI](../clients/vespa-cli.html), or download
...
{% include setup.html appname='billion-scale-image-search' %}
...
- [ranker_export.py](https://github.com/vespa-engine/sample-apps/tree/master/billion-scale-image-search/src/main/python/ranker_export.py)
- [similarity_export.py](https://github.com/vespa-engine/sample-apps/tree/master/billion-scale-image-search/src/main/python/similarity_export.py)
- [pca_transformer_export.py](https://github.com/vespa-engine/sample-apps/tree/master/billion-scale-image-search/src/main/python/pca_transformer_export.py)
...
Run [Vespa System Tests](../reference/applications/testing.html),
...
Fetch a single document using [document api](../reference/api/document-v1.html):
...
The `text` [rank](../basics/ranking.html) profile uses
[nativeRank](../ranking/nativerank.html), one of Vespa's many
