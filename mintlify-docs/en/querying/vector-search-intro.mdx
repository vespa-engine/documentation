...
| <Columns cols={3}><Frame>![DandelionFlower.jpg](https://upload.wikimedia.org/wikipedia/commons/4/4f/DandelionFlower.jpg)</Frame></Columns> | [0.560, 0.001, 0.223, ...] |
|:---|:---|
| <Columns cols={2}><Frame>![Dandelion bu Anna of the North](/assets/img/dandelion-song.png)</Frame></Columns> | [0.0, 0.011, 0.0, ...] |
