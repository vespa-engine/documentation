---
title: "An intro to vector search"
---
...
The cost/quality tradeoff is essential - given a vector, it can be represented with lower precision or shortened, keeping the most relevant dimensions. This reduces search precision, but cuts costs into a fraction. A 75% cost reduction might reduce precision, but acceptable for the use case. Vespa supports [four types](../reference/ranking/tensor), with an 8x difference in memory cost:

<table className="vespa-table">
  <thead>
    <tr>
      <th>Int8</th>
      <th>8 bits, 1 byte per dimension</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>bfloat16</td>
      <td>16 bits, 2 bytes per dimension</td>
    </tr>
    <tr>
      <td>float</td>
      <td>32 bits, 4 bytes per dimension</td>
    </tr>
    <tr>
      <td>double</td>
      <td>64 bits, 8 bytes per dimension</td>
    </tr>
  </tbody>
</table>
...
-   [approximate-nn-hnsw](/en/querying/approximate-nn-hnsw)
