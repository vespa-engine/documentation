...
| **content.proton.resource_usage.disk** | A number between 0 and 1, indicating how much disk (of total available) is used on the content node. Transient disk used during [disk index fusion](/en/content/proton#disk-index-fusion) is not included. |
| **content.proton.resource_usage.memory** | A number between 0 and 1, indicating how much memory (of total available) is used on the content node. Transient memory used by [memory indexes](/en/content/proton#memory-index-flush) is not included. |
