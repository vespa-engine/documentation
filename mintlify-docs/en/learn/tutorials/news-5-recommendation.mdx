...
Introducing the HNSW `index` requires a content node restart. On Vespa Cloud, this is handled automatically after deployment — wait for the deployment to complete and the application to become ready:
