...
| --- | --- | --- |
| **Containers** | • Add new sidecar containers. <br/>• Add env vars/mounts to main container. | • Cannot change main container image, command, or args. <br/>• Cannot override main container CPU/Memory resources (these are locked to `services.xml`). |
