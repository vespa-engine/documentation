...
| Item | Description |
| --- | --- |
| **Enabled GCP APIs** | The *Compute Engine*, *Service Directory* and *Cloud DNS* APIs must all be enabled in your GCP account:<br/><br/>`$ gcloud services enable compute.googleapis.com`<br/> `$ gcloud services enable dns.googleapis.com`<br/> `$ gcloud services enable servicedirectory.googleapis.com` |
