...
- Removing the `<region>` element from the relevant `<endpoint>` elements in [deployment.xml](/en/reference/applications/deployment) and deploying a new version of your application.
