...
|||
|---|---|
| **vmstat** | *vmstat* can be used to figure out what kind of resources are used:<br/><br/>• cpu usage split in user, system, idle, and io wait: system should be low(`<10`)<br/>• swap in/out: should be zero.<br/><br/><Note>**Note:**<br/> A maxed out system should have either maxed out disks or cpu (`idle == 0`). If not, there might be lock contention or the system is bottlenecked by upstream services.</Note><br/><br/>Example:<br/><br/>`$ vmstat 1`<br/><br/>`procs -----------memory---------- ---swap-- -----io---- --system-- ----cpu----`<br/>`r  b   swpd   free   buff  cache   si   so    bi    bo   in    cs us sy id wa`<br/>`0  0   5628 3315460 304024 23008616    0    0    14    34    0     0  0  0 99  0`<br/>`1  0   5628 3298884 304024 23008640    0    0     0   396   33  4615  9  1 90  0`<br/>`0  0   5628 3316336 304028 23008644    0    0     0     0   15  4469  4  1 95  0`<br/>`0  0   5628 3316592 304028 23008644    0    0     0     0   24  4364  0  0 100  0`<br/>`0  0   5628 3316592 304028 23008644    0    0     0  2948   20  4305  0  0 100  0`<br/>`0  0   5628 3316468 304028 23008644    0    0     0     0   22  4259  0  0 100  0`<br/>`0  0   5628 3316468 304028 23008644    0    0     0   180   20  4279  0  0 100  0`<br/>`0  0   5628 3316468 304028 23008644    0    0     0     0   26  4349  0  0 100  0`<br/>`16  0   5628 3284236 304056 23008688    0    0    12   188   17  9196 38  2 60  0`<br/>`19  0   5628 3267020 304056 23008732    0    0     8   128   44  6408 99  1  0  0`<br/>`16  0   5628 3245472 304060 23008840    0    0    20     0    9  7191 99  1  0  0`<br/>`17  0   5628 3227784 304060 23008872    0    0    20     0   27  6420 99  1  0  0`|
