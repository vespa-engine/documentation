...
sidebarTitle: "HTTP performance testing"
---
...
Running a single query over and over again is not useful, so we have a tiny query log in a CSV file we want to run in our test, *user-files/data/userinput.csv*:
