...
Valgrind is a useful tool to investigate bugs, and to get a detailed performance profile of an application after [profiling](/en/performance/profiling) to get the higher level picture. This documents how to run Vespa processes with valgrind.
