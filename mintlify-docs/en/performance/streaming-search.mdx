...
- Since there are no indexes, the content nodes do not collect term statistics and average field length statistics.
	...
	- If using *bm25*, adjust the [averageFieldLength](/en/reference/ranking/rank-feature-configuration#properties) configuration for a more precise *bm25* score. The [num_docs_indexed](/en/reference/ranking/rank-features#num_docs_indexed) rank feature returns 1 in streaming search.
