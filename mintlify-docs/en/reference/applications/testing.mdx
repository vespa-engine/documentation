...
| cluster | defaults request | string |  | The name of the Vespa cluster to send a request to, as specified in [services.xml](/en/reference/applications/services/services). If this is not specified, and the application has a single container cluster, this is used. |
