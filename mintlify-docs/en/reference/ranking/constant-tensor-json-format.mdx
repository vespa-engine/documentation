...
The "type" field is optional, but must match the [canonical form of the tensor type](#canonical-type) if present. This format is similar to "Indexed tensors short form" in the [document JSON format](/en/reference/schemas/document-json-format#tensor-short-form-indexed).
...
The "type" field is optional. This format is similar to "Short form for tensors with a single mapped dimension" in the [document JSON format](/en/reference/schemas/document-json-format#tensor-short-form-mapped).
...
This format is also known as the [general verbose form](/en/reference/schemas/document-json-format#tensor), and it's possible to use it for any tensor type.
...
The "type" field is optional, but must match the [canonical form of the tensor type](#canonical-type) if present. This format is similar to the first variant of "Mixed tensors short form" in the [document JSON format](/en/reference/schemas/document-json-format#tensor-short-form-mixed).
...
Again, the "type" field is optional. This format is similar to the second variant of "Mixed tensors short form" in the [document JSON format](/en/reference/schemas/document-json-format#tensor-short-form-mixed).