...
| --- | --- | --- |
| com.yahoo.search.predicate | *PredicateIndex* + related classes | The Predicate Search Java Library is removed (*com.yahoo.vespa:predicate-search*). Use [predicate fields](/en/schemas/predicate-fields.) in Vespa instead. |
