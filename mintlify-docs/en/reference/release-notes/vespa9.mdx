...
<table className="vespa-table">
  ...
  <tbody>
    <tr>
      ...
      <td>&#42;PredicateIndex&#42; + related classes</td>
      <td>The Predicate Search Java Library is removed (&#42;com.yahoo.vespa:predicate-search&#42;). Use <a href="/en/schemas/predicate-fields." aria-label="predicate fields">predicate fields</a> in Vespa instead.</td>
    </tr>
  </tbody>
</table>
...
Vespa can calculate and return all [rank-features](/en/reference/api/query#ranking.listfeatures) in the `rankfeatures` summary field. Vespa 9 contains some changes to this list:

### Upgrade procedure

See [upgrade procedure](/en/operations/self-managed/live-upgrade) for how to upgrade.