...
| Ellipsis | â€¦ | Matches any sequence to make the overall condition match | The matched sequence |
| Referable ellipsis | [â€¦] | An ellipsis where the matched sequence can be referenced from the production | The matched sequence |
